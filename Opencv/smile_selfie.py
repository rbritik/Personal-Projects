...
face_cascade = cv.CascadeClassifier(r'Opencv\haar-cascade-files-master\haarcascade_frontalface_alt.xml')
smile_cascade = cv.CascadeClassifier(r'Opencv\haar-cascade-files-master\haarcascade_smile.xml')
while True:
    ok, frame = video.read()
    ...
    for x,y,w,h in face_rect:
        ...
        for x,y,w,h in smile_rect:
            ...
            img_path = r'Saved Pictures\img'+str(cnt)+'.jpg'
